...
Border getBorders(int index) {
  switch (index) {
    case 0: return Border(
        ...
        right: BorderSide(width: 2, color: Colors.deepOrange)
    );
    case 1: return Border(
        bottom: BorderSide(width: 2, color: Colors.deepOrange),
        left: BorderSide(width: 2, color: Colors.deepOrange),
        right: BorderSide(width: 2, color: Colors.deepOrange)
    );
    ...
    case 4: return Border.all(width: 2, color: Colors.deepOrange);
  ...
  return Border.all(width: 2, color: Colors.deepOrange);
}
